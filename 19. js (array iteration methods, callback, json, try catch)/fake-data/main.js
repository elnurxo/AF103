...
//reduce
const sumUnitPrice = products.reduce((previousValue,currentValue)=>{
    return previousValue + currentValue.unitPrice;
},0);

// console.log(Math.random(sumUnitPrice));

//filter
// const filterByCountry = products.filter((value)=>{
//     return value.supplier?.address?.country==='USA';
// })
// console.log(filterByCountry);

//find
// const search = products.find((item)=>item.name==='Genen Shouyu')
// console.log(search);

//map
// const newArr = products.map((item)=>item.unitPrice+5)
// console.log(newArr);
